...
fn register_utils(handlers: &mut RuntimeHandlers) {
    ...
    module.register_sync_fn(crate::utils::compress, crate::utils::compression::compress_api);
    module.register_sync_fn(crate::utils::decompress, crate::utils::compression::decompress_api);
    module.register();
}
